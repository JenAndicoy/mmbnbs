(function() {
//    var c = {
//        id: "7f70df09d6dc5f12842a518bf47a9e14",
//        dm: ["m.1758.com"],
//        etrk: [],
...
//    };
        ...
        return function(d) {
            switch (typeof d) {
                ...
                default:
                    ...
                    k = ["{"];
                    for (h in d)
                        if (Object.prototype.hasOwnProperty.call(d, h)) switch (g = d[h], typeof g) {
                            case "undefined":
                            case "unknown":
                            case "function":
                                break;
        ...
        k: function(a) {
            if (N(a, "Array")) {
                ...
                switch (a[0]) {
                    case "_trackPageview":
                        if (1 <
                            a.length && a[1].charAt && "/" == a[1].charAt(0)) {
                            this.a.api |= 4;
                            this.a.et = 0;
                            this.a.ep = "";
                    ...
                    case "_trackMobConv":
                        if (a = {
                            ...
                            32, this.a.et = 93, this.a.ep = a, W(this);
                        break;
    ...
    function pa() {
        ...
        if (a)
            for (var a = a.split(","), b = 0, d = a.length; b < d; b++) z(Q + "//" + decodeURIComponent(a[b]).replace(/^https?:\/\//, ""), function(a) {
                X(a)
            })
    }
    ...
    function ka(a) {
        try {
                ...
                switch (s[1]) {
                    case "swf":
                        var da = s[2],
                            ...
                            J = "s=" + S,
                            B = "HolmesIcon" + P;
                        r = '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="' + B + '" width="' + da + '" height="' + ea + '"><param name="movie" value="' + T + '" /><param name="flashvars" value="' + (J || "") +
                            '" /><param name="allowscriptaccess" value="always" /><embed type="application/x-shockwave-flash" name="' + B + '" width="' + da + '" height="' + ea + '" src="' + T + '" flashvars="' + (J || "") + '" allowscriptaccess="always" /></object>';
                        break;
                    case "gif":
            ...
            a.m && a.m();
            a.l && a.l();
            if (c.rec || c.trust) a.a.nv ? (a.g = encodeURIComponent(document.referrer), window.sessionStorage ? w("Hm_from_" + c.id, a.g) : E("Hm_from_" + c.id, a.g, 864E5)) : a.g = (window.sessionStorage ? x("Hm_from_" + c.id) :
                H("Hm_from_" + c.id)) || "";
            a.n && a.n();
            a.o && a.o();
            a.e = new ta;
            ...
            a = [], a.push("si=" + c.id), a.push("n=" + encodeURIComponent(ga.name)), a.push("m=" + encodeURIComponent(ga.message)), a.push("r=" + encodeURIComponent(document.referrer)), z(Q + "//hm.baidu.com/hm.gif?" + a.join("&"))
        }
    }
